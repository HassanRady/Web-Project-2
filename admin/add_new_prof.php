            ...
            <div class="page-body">
                ...
                <div class="row">
                    <div class="col-md-12 order-md-1 col-lg-12">
                        ...
                        <hr class="mb-4">
                        <form action="add_new_prof.php?type=professor" method="POST" onsubmit="return !!(empty_field1() & validate_instructorid() & validate_names() & validate_email() &  validate_MobileNumber() & validate_HomeNumber() & validate_NationalId()  & validate_gender());" novalidate>
                            <div class="row">
