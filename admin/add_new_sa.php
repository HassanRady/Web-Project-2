            ...
            <div class="page-body">
                ...
                <div class="row">
                    <div class="col-md-12 order-md-1 col-lg-12">
                        ...
                        <hr class="mb-4">
                        <form action="add_new_sa.php?type=sa" method="POST" onsubmit="return !!(empty_field1() & validate_names() & validate_email() &  validate_MobileNumber() & validate_HomeNumber() & validate_instructorid() & validate_NationalId() & validate_gender()  );" novalidate>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="aboutTextArea" name="department" style="resize: none; height: 150px;"></textarea>    
                                  </div>
