                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-12 mb-3">
                                    ...
                                    <select class="custom-select d-block w-100" name="category" id="category" required>
                                        ...
                                        <option value='univerity'>Univerity</option>
                            ...
                            <div class="row">
                                <div class="col-sm-12 mb-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" class="form-check-input" name="practicalCheckbox" id="practicalCheckbox">
                                        <label class="form-check-label" for="practicalCheckbox" value='1'>This course is practical</label>
                                    </div>
                                    <div class="form-group form-check">
                                        <input type="checkbox" class="form-check-input" name="sectionsCheckbox" id="sectionsCheckbox">
                                        <label class="form-check-label" for="sectionsCheckbox" value='1'>This course has labs/sections</label>
                                    </div>
                                </div>
