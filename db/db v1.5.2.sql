...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2020 at 02:19 PM
...
CREATE TABLE `students` (
  ...
  `arabic_name` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `guardian_mobile_number` int(12) NOT NULL,
...
ALTER TABLE `courses`
  ...
  ADD UNIQUE KEY `prof_id` (`id_instructor`);
...
--
ALTER TABLE `courses`
  ADD CONSTRAINT `id_instructor_courses_fk` FOREIGN KEY (`id_instructor`) REFERENCES `instructors` (`instructor_id`) ON DELETE CASCADE ON UPDATE CASCADE;
